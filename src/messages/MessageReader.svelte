  ...
  {#if message}
    <header class="border-b border-zinc-200 dark:border-zinc-800">
      <div class="mx-auto w-full max-w-[800px] p-6">
        {#if expired}
          <div
            class="mb-4 flex items-center gap-2 rounded-lg bg-amber-100 px-3 py-2 text-sm font-semibold text-amber-900 dark:bg-amber-950/60 dark:text-amber-100"
          >
            This access mail has expired. Its code or link is no longer valid.
          </div>
        {/if}
        <h2
